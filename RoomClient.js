...
class RoomClient {
    ...
    ServerAway() {
        ...
        Swal.fire({
            ...
            title: 'سرور دور',
            text: 'به نظر می رسد سرور دور است یا در حال تعمیر است، لطفاً صبر کنید تا دوباره بالا بیاید',
            denyButtonText: `ترک جلسه`,
    ...
    userNameAlreadyInRoom() {
        ...
        Swal.fire({
            ...
            position: 'center',
            title: 'نام کاربری',
            html: `این نام کاربری در حال حاضر موجود است <br/> لطفا از یکی دیگر استفتده کنید`,
    ...
    async produce(type, deviceId = null, swapCamera = false, init = false) {
        ...
        try {
            ...
            if (!audio && !screen && videoQuality.selectedIndex != 0) {
                ...
                this.userLog(
                    'خطا',
                    `دستگاه شما از کیفیت ویدیوی انتخابی پشتیبانی نمی کند (${videoQuality.value}), لطفا یکی دیگر را انتخاب کنید.`,
                    'top-end',
                );
            }
        }
        ...
        switch (type) {
            ...
            case mediaType.screen:
                ...
                if (!this.isMobileDevice) {
                    this.setTippy(pn.id, 'پین کردن', 'bottom');
                    this.setTippy(pip.id, 'تصویر در تصویر', 'bottom');
                    this.setTippy(ts.id, 'عکس فوری', 'bottom');
                    this.setTippy(vp.id, 'حریم خصوصی ویدئو', 'bottom');
                    this.setTippy(au.id, 'وضعیت صدا', 'bottom');
                }
    ...
    handleFS(elemId, fsId) {
        ...
        if (btnFs) {
            this.setTippy(fsId, 'تمام صفحه', 'bottom');
    ...
    userUnauthorized() {
        ...
        Swal.fire({
            ...
            title: 'اوه، غیرمجاز',
            text: 'هاست احراز هویت کاربر را فعال کرده است',
    ...
    isBanned() {
        ...
        Swal.fire({
            ...
            imageUrl: image.forbidden,
            title: 'ممنوع',
            text: 'شما از این اتاق منع شده اید!',
            confirmButtonText: `Ok`,
            showClass: { popup: 'animate__animated animate__fadeInDown' },
            hideClass: { popup: 'animate__animated animate__fadeOutUp' },
        }).then(() => {
