...
function refreshMainButtonsToolTipPlacement() {
    if (!DetectRTC.isMobileDevice) {
        ...
        setTippy('shareButton', 'اشراک گذاری اتاق', placement);
        setTippy('hideMeButton', 'پنهان کردن خود', placement);
        setTippy('startAudioButton', 'صدا روشن شود', placement);
        setTippy('stopAudioButton', 'صدا قطع شود', placement);
        setTippy('startVideoButton', 'تصویر روشن شود', placement);
        setTippy('stopVideoButton', 'تصویر قطع شود', placement);
        setTippy('startScreenButton', 'اشتراک گذاری صفحه', placement);
        setTippy('stopScreenButton', 'قطع اشتراک گذاری', placement);
        setTippy('startRecButton', 'شروع ظبط', placement);
        setTippy('stopRecButton', 'قطع ظبط', placement);
        setTippy('raiseHandButton', 'بالا بردن دست', placement);
        setTippy('lowerHandButton', 'پایین آوردن دست', placement);
        setTippy('emojiRoomButton', 'با ایموجی عکس‌العمل نشان دهید', placement);
        setTippy('swapCameraButton', 'دوربین را عوض کنید', placement);
        setTippy('chatButton', 'چت کردن', placement);
        setTippy('transcriptionButton', 'رونویسی', placement);
        setTippy('whiteboardButton', 'وایت برد', placement);
        setTippy('settingsButton', 'تنظیمات', placement);
        setTippy('aboutButton', 'در مورد پروژه', placement);
        setTippy('exitButton', 'خروج', placement);
    }
}
...
async function whoAreYou() {
    ...
    Swal.fire({
        ...
        confirmButtonText: `پیوستن به جلسه`,
...
async function shareRoom(useNavigator = false) {
    ...
    function share() {
        ...
        Swal.fire({
            background: swalBackground,
            position: 'center',
            title: 'اتاق را به اشتراک بگذارید',
            html: `
            <div id="qrRoomContainer">
                <canvas id="qrRoom"></canvas>
            </div>
            <br/>
            <p style="background:transparent; color:rgb(8, 189, 89);">از دستگاه تلفن همراه خود بپیوندید</p>
            <p style="background:transparent; color:white; font-family: Arial, Helvetica, sans-serif;">بدون نیاز به برنامه، به سادگی بارکد را با دوربین موبایل خود بخوانید یا با ارسال لینک زیر از شخص دیگری دعوت کنید تا به آن بپیوندد.</p>
...
function setButtonsInit() {
    if (!DetectRTC.isMobileDevice) {
        setTippy('initAudioButton', 'صدا', 'top');
        setTippy('initVideoButton', 'تصویر', 'top');
        setTippy('initAudioVideoButton', 'صدا و تصویر', 'top');
        setTippy('initStartScreenButton', 'اشتراک گذاری صفحه', 'top');
        setTippy('initStopScreenButton', 'اشتراک گذاری صفحه', 'top');
    }
...
function leaveFeedback() {
    Swal.fire({
        ...
        text: 'آیا میخواهید به دیدار امتیاز بدهید؟',
    ...
    Swal.fire({
        ...
        <div id="about">
            ...
            Email:<a 
                ...
                href="mailto:www.@gmail.com?subject=didar"> 
                www.@gmail.com
            </a>
        </div>
        `,
